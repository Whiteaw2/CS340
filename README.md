...
- The primary ways to keep programs maintainable, readable, and adaptable are to think about the key principles of the software development lifecycle, including requirements analysis, planning, iterative development, modularity, testing, and well documented. By making sure that at the very least your code meets the requirements of users and is clearly explained in the areas of functionality and required improvements, you ensure that others can interface with and easily understand the logic therein. By ensuring that code is broken up into as few pieces as possible and that those pieces reduce the redundancy in your work, you maximize the chance that your code will be easy to understand and troubleshoot. Lastly, by frequently building your code and iterating against the product requirements, you stand the best chance of improving your design without becoming lost in changes by introducing too many variables.
  
* How do you approach a problem as a computer scientist? Consider how you approached the database or dashboard requirements that Grazioso Salvare requested. How did your approach to this project differ from previous assignments in other courses? What techniques or strategies would you use in the future to create databases to meet other client requests?
- The way that I approach problems as a computer scientist is to first analyze the user, their needs, and the simplest set of tools that will result in the longest-term, most easily maintainable solution. This held true when working through the Grazioso Salvare assignments and manifested in a series of incremental functionality improvements until the user requirements were satisfied. The product for this course differed from those in other courses in that it was a full-stack assignment which required a great deal more planning, orchestration, and research as it involved several technologies, languages, and methodologies. Also, this product required working with web frameworks and backend technologies which that I had less experience with.
  
* What do computer scientists do, and why does it matter? How would your work on this type of project help a company, like Grazioso Salvare, to do their work better?
- Computer scientists leverage a variety of technologies and harness a deep understanding of computer hardware, software, and design patterns to produce solutions for end users. Increasingly, modern problems require the interconnection and simplification of interface between users and computer systems to bring relevant tools to those in need. In the course's example with Grazioso Salvare, the systems developed would increase the speed and visibility workers have to the data. Generally, data is obtuse and can be confusing to work with and generate insights. Through the product I developed, the operations of the company would be faster, more relevant, and more enjoyable, ultimately resulting in faster and more effective work with animals.
